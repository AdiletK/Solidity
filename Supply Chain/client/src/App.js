...
class App extends Component {
  state = { cost:0, itemName: "example1", loaded: false };
  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        <h2>Add item</h2>
        Cost: <input type="text" name="cost" value={this.state.cost} onChange={}/>
        Item name: <input type="text" name="itemName" value={this.state.itemName} onChange={}/>

        <button type="button" onClick={}>Create new Item</button>
